...
<body class="bg-slate-50 antialiased" x-data="{ collapsed: false, mobileOpen: false }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        {{-- ════════════════════════════════
         SIDEBAR
    ════════════════════════════════ --}}
        <aside :class="collapsed ? 'w-[68px]' : 'w-[230px]'"
            ...
            <div class="flex items-center h-14 border-b border-white/[.06] px-4 overflow-hidden flex-shrink-0"
                ...
                <div
                    class="w-9 h-9 rounded-xl bg-green-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-green-900/40">
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden px-2 py-3 space-y-0.5 scrollbar-none">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Dashboard</span>
                </a>
                ...
                <a href="{{ route('admin.blogs.index') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Blogs</span>
                </a>
                ...
                <a href="{{ route('admin.seo.index') }}"
                    ...
                    <span class="sidebar-label" :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">SEO
                        Manager</span>
                </a>
                ...
                <a href="{{ route('admin.applications.index') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Leads</span>
                </a>
                ...
                <a href="{{ route('admin.visitors.index') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Visitors</span>
                </a>
                ...
                <a href="{{ route('admin.redirects.index') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Redirects</span>
                </a>
                ...
                <a href="{{ route('admin.settings.index') }}"
                    ...
                    <span class="sidebar-label"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Settings</span>
                </a>
            ...
            <div class="border-t border-white/[.06] px-2 py-2">
                <button @click="collapsed = !collapsed"
                    ...
                    <svg :class="collapsed ? 'rotate-180' : ''"
                        class="w-[18px] h-[18px] transition-transform duration-200 flex-shrink-0" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11 19l-7-7 7-7M18 19l-7-7 7-7" />
                    </svg>
                    <span class="sidebar-label text-[13.5px]"
                        :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Collapse</span>
                </button>
            </div>
        </aside>
    ...
    ════════════════════════════════ --}}
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            {{-- Top bar --}}
            <header
                class="flex items-center justify-between bg-white border-b border-gray-100 px-5 py-0 flex-shrink-0 shadow-sm h-14">
                    ...
                    <div x-data="{ userMenu: false }" class="relative">
                        ...
                        <div x-show="userMenu" x-cloak @click.outside="userMenu = false"
                            ...
                            <div class="px-4 py-3 border-b border-gray-100">
                                <p class="text-sm font-semibold text-gray-900">{{ auth()->user()->name ?? 'Admin' }}
                                </p>
