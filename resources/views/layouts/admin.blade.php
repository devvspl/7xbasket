        ...
        <nav class="flex-1 overflow-y-auto overflow-x-hidden px-2 py-3 space-y-0.5 scrollbar-none">
            ...
            <a href="{{ route('admin.applications.index') }}"
               ...
               :class="collapsed ? 'justify-center px-0' : 'gap-[11px]'">
                ...
                <span class="sidebar-label" :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Leads</span>
            </a>
            ...
            <a href="{{ route('admin.redirects.index') }}"
               ...
               :class="collapsed ? 'justify-center px-0' : 'gap-[11px]'">
                ...
                <span class="sidebar-label" :class="collapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Redirects</span>
            </a>
        ...
        <aside class="relative w-[230px] bg-[#0f172a] flex flex-col h-full z-10">
            ...
            <nav class="flex-1 overflow-y-auto px-2 py-3 space-y-0.5">
                ...
                <a href="{{ route('admin.redirects.index') }}" class="nav-link {{ request()->routeIs('admin.redirects*') ? 'active' : '' }}">
                    <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25"/></svg>
                    Redirects
                </a>
            </nav>
