...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5XDDB2LH"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class="sticky top-0 z-50" x-data="{ scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 10)">
            ...
            <div class="max-w-7xl mx-auto px-4 py-1 flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    <button @click="show = false"
                        class="text-white/60 hover:text-white transition-colors p-0.5 flex-shrink-0" aria-label="Close">
        ...
        {{-- Navbar --}}
        <nav x-data="{ open: false }" :class="scrolled ? 'shadow-md' : 'shadow-sm'"
            class="bg-white border-b border-gray-100 transition-shadow duration-300">
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center gap-8">
                        ...
                        <a href="{{ route('calculator') }}"
                            class="text-sm font-medium text-gray-600 hover:text-green-600 transition-colors {{ request()->routeIs('calculator') ? 'text-green-600' : '' }}">Calculator</a>
                        <a href="{{ route('blogs') }}"
                            class="text-sm font-medium text-gray-600 hover:text-green-600 transition-colors {{ request()->routeIs('blogs*') ? 'text-green-600' : '' }}">Blogs</a>
                        <a href="{{ route('contact') }}"
                            class="text-sm font-medium text-gray-600 hover:text-green-600 transition-colors {{ request()->routeIs('contact') ? 'text-green-600' : '' }}">Contact</a>
            ...
            <div x-show="open" x-cloak class="md:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-3">
                ...
                <a href="{{ route('calculator') }}"
                    class="block text-sm font-medium text-gray-700 hover:text-green-600">Calculator</a>
                <a href="{{ route('apply') }}"
                    class="block text-sm font-medium text-gray-700 hover:text-green-600">Apply Franchise</a>
                <a href="{{ route('contact') }}"
                    class="block text-sm font-medium text-gray-700 hover:text-green-600">Contact</a>
                <a href="#" onclick="openLeadPopup('brochure'); return false;"
                    class="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-[#055346]">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
    ...
    {{-- Footer --}}
    <footer
        class="overflow-x-hidden relative overflow-hidden bg-gradient-to-br from-[#055346] via-[#076b58] to-[#055346] text-green-100 pt-16 pb-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('calculator') }}"
                                class="text-green-200 hover:text-white transition-colors">Calculator</a></li>
                        <li><a href="{{ route('apply') }}"
                                class="text-green-200 hover:text-white transition-colors">Apply Franchise</a></li>
                        <li><a href="{{ route('contact') }}"
                                class="text-green-200 hover:text-white transition-colors">Contact</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-green-200">
                        <li><a href="mailto:info@7xbasket.com" class="hover:text-white transition-colors">📧
            ...
            <div
                class="border-t border-white/20 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-green-300">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://www.facebook.com/7xbasketofficial" target="_blank" rel="noopener"
                        class="w-8 h-8 bg-white/10 hover:bg-[#1877F2] rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110"
                        title="Facebook">
                    ...
                    <a href="https://www.instagram.com/7xbasket" target="_blank" rel="noopener"
                        class="w-8 h-8 bg-white/10 hover:bg-[#e1306c] rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110"
                        title="Instagram">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.youtube.com/@7xBasket" target="_blank" rel="noopener"
                        class="w-8 h-8 bg-white/10 hover:bg-[#FF0000] rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110"
                        title="YouTube">
                        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path
    ...
    <a href="#" onclick="openLeadPopup(); return false;" title="Apply for Franchise" id="stickyApplyBtn"
    ...
    <div id="leadPopup" class="fixed inset-0 z-[999] flex items-center justify-center p-4 hidden">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg z-10 animate-popup">
            ...
            {{-- Form --}}
            <form id="leadPopupForm" action="{{ route('apply.store') }}" method="POST"
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 mb-1">Store Area (sq. ft.) <span
                                class="text-[#109125]">*</span></label>
                ...
                {{-- Property Ownership --}}
                <div>
                    <label class="block text-xs font-bold text-gray-600 mb-1">Property Ownership Type <span
                            class="text-[#109125]">*</span></label>
                ...
                {{-- Opening Timeline --}}
                <div>
                    <label class="block text-xs font-bold text-gray-600 mb-1">Planned Store Opening Timeline <span
                            class="text-[#109125]">*</span></label>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                var submittedName = form.querySelector('[name="name"]') ? form.querySelector(
                    '[name="name"]').value : '';
                var submittedPhone = form.querySelector('[name="phone"]') ? form.querySelector(
                    '[name="phone"]').value : '';
