...
<section class="relative overflow-hidden bg-gradient-to-br from-[#055346] via-[#076b58] to-[#055346] py-10 text-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <h1 class="text-4xl font-extrabold text-white mt-2">Apply for Franchise</h1>
        <p class="text-green-100/80 text-base mt-2 max-w-lg mx-auto">Fill in your details and our team will contact you within 24 hours.</p>
